...
import OOP.ParametrizedClasses.AverageAge;

import java.util.*;

import OOP.ParametrizedClasses.*;
...
//        }
//        Employee employee0 = new Employee("John", "SilverHand", 32, "Musician");
//        EmployeeController empContr = new EmployeeController();
//        empContr.paySalary(employee0);

        /***
         * Creating new objects by using services
         */


        StudentService studentService = new StudentService();
        studentService.Create("Morgan", "Freeman", 50);
        studentService.Create("Tim", "Cook", 62);
        studentService.Create("Jessie", "Cook", 21);

//        List<StudentService> s = new ArrayList<>();


        EmployeeService employeeService = new EmployeeService();
        employeeService.Create("John", "SilverHand", 32);
        employeeService.Create("Walter", "White", 56);

//        List<EmployeeService> e = new ArrayList<>();

//        ParamIterator iterator0 = new ParamIterator(s);
//        ParamIterator iterator1 = new ParamIterator(e);
//        iterator0.printToConsole();
//        iterator1.printToConsole();
        /***
         * Examples of AverageAge class and printing Services Lists
         */
        AverageAge studAge = new AverageAge();
        AverageAge employeeAge = new AverageAge();
        studentService.printToConsole();
        employeeService.printToConsole();
        /***
         * Summarizing Students and Employee ages and print an average number
         */
        studAge.ageSum(studentService.getAll());
        employeeAge.ageSum(employeeService.getAll());
        System.out.println(studAge.getAverageAge());
        System.out.println(employeeAge.getAverageAge());
    }
}
